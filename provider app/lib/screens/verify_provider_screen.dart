...
import 'package:handyman_provider_flutter/screens/shimmer/verify_provider_shimmer.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Observer(builder: (context) => VerifyProviderShimmer().visible(appStore.isLoading)),
        ],
      ),
    );
  }
